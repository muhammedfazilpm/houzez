...
const Carousel = () => {
      ...
      <div className="container mx-auto">
        <div className="overflow-hidden">
          ...
          >
            ...
            <video 
    style={{filter: 'brightness(50%)', minHeight: "480px"}} 
    className="w-full" 
    src="/demo.mp4" 
    autoPlay 
    loop 
  ...
  <div 
    style={{display: 'flex', justifyContent: 'center', flexDirection: "column", color: 'white'}} 
    className="absolute top-0 left-0 w-full h-full flex justify-center items-center"
  >
    <h2 style={{fontSize: "25px"}}>A Legacy of Trust</h2>
    <h3>Building homes for a decade with precision, passion, and a commitment to quality.</h3>
    <button 
      onClick={() => navigate("/about")}  
      className="bg-blue-500 text-white p-2 hover:bg-blue-400 mt-10"
    >
      Learn About Us
    </button>
  </div>
